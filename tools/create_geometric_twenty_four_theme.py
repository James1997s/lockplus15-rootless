...
<section class="header" aria-label="Time and date">
  ...
  <div id="clock-time" class="clock-time">17:13</div>
  <div class="rule"></div>
  ...
  <div id="numeric-date" class="numeric-date">MAY 2</div>
